...
import com.tigrex.rules.provider.model.vo.KindVO;
...
public class KindController {
    ...
    public KindVO getKind(@RequestBody() KindQuery query) throws JsonProcessingException {
        return JacksonUtils.getJackson().convertValue(service.getKind(query), KindVO.class);
    }
}
